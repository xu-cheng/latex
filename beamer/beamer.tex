...
\DeclareOptionX{biblatex}[]{
    \@biblatextrue
    \ifthenelse{\equal{#1}{}}{
        \PassOptionsToPackage{bibstyle=alphabetic,citestyle=alphabetic}{biblatex}
    }{
...
\hypersetup{allcolors=.} % "." refers to the current color
...
% Beamer Utility function
\long\def\themecolor#1{{\usebeamercolor[fg]{structure} #1}}
